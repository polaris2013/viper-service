...
//    System.out.println("----WordSegmenter本身功能不强，调用hhmmSegmenter----"
//			+ this.getClass().getName());
    List<SegToken> segTokenList = hhmmSegmenter.process(sentence);
    
//    System.out.println("\r\n----hhmmSegmenter结果已经出来了。（如果想看分词的具体方法，回去看HHMMSegmenter，）看一下结果：----");
//    System.out.println("------------------------------------------\r\n");
    
    int listNum=0;
    for(SegToken token:segTokenList){
//    	System.out.println("    "+listNum+"  "+new String(token.charArray));
    	listNum++;
    }
//    System.out.println("------------------------------------------\r\n");
